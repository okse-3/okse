...
public class ConfigControllerTest {
  ...
  public void setup() throws NoSuchFieldException, IllegalAccessException {
    ...
    CoreService.getInstance().bootProtocolServers(
        new BufferedInputStream(new ReaderInputStream(new StringReader(xml_cfg))));
  ...
  public void testWsnRelay() {
    ...
    str = configController.addRelay(0, "http://127.0.0.1:" + PORT2 + "/", "testRelay", 11)
        .getBody();
  ...
  public void testBadWsnRelay() {
    ...
    configController.addRelay(0, "http://127.0.0.1:" + PORT2 + "/", "testRelay", 11);
    ...
    str = configController.addRelay(0, "http://127.0.0.1:" + PORT1 + "/", "testRelay", 11)
        .getBody();
    Assert.assertTrue(str.contains("Unable"));
