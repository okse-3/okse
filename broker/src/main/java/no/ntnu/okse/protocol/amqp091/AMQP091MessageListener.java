...
public class AMQP091MessageListener implements AMQPMessageListener, SubscriptionChangeListener {
  ...
  public void onDisconnect(DisconnectMessage disconnectMessage) {
    ...
    List<Subscriber> subscribers = subscriberMap
        .getSubscribers(disconnectMessage.getHost(), disconnectMessage.getPort());
  ...
  public void onMessageReceived(MessageReceived messageReceived) {
    ...
    MessageService.getInstance()
        .distributeMessage(new Message(message, topic, null, protocolServerType));
