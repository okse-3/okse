...
/**
 * This class will listen to the MESSAGE message type and whenever one is received it will send that
 * message into OKSE. It also has special handling for adding any user defined headers to the OKSE
 * message.
 *
...
public class MessageListener implements StampyMessageListener {
  ...
  /**
   * Sets the message service for the class, used for sending message into OKSE
   *
  ...
  /**
   * Sets the protocol server, used to increment total number of message received
   *
