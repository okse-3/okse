...
/**
 * This class is a security class for STOMP, it requires the first listener to implement
 * SecurityMessageListener. We do not want security and so this class does nothing.
 */
